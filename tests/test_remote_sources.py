...
class TestNotImplementedProvider(unittest.TestCase):
    ...
    def test_not_implemented_provider_auth_error_includes_provider_name(self):
        from data.source.remote_sources import _NotImplementedProvider
        provider = _NotImplementedProvider("custom-provider")
        self.assertIn("custom-provider", provider.auth_error)
        self.assertIn("not implemented", provider.auth_error.lower())

    def test_not_implemented_provider_get_user_info_raises(self):
        from data.source.remote_sources import _NotImplementedProvider
    ...
    def test_not_implemented_provider_list_repositories_raises(self):
        from data.source.remote_sources import _NotImplementedProvider
        from utils.errors import ProviderNotImplementedError
        provider = _NotImplementedProvider("custom-provider")
        with self.assertRaises(ProviderNotImplementedError):
    ...
    def test_not_implemented_provider_get_repository_raises(self):
        from data.source.remote_sources import _NotImplementedProvider
        from utils.errors import ProviderNotImplementedError
        provider = _NotImplementedProvider("custom-provider")
        with self.assertRaises(ProviderNotImplementedError):
    ...
    def test_not_implemented_provider_list_branches_raises(self):
        from data.source.remote_sources import _NotImplementedProvider
        from utils.errors import ProviderNotImplementedError
        provider = _NotImplementedProvider("custom-provider")
        with self.assertRaises(ProviderNotImplementedError):
