...
class TestDownloader(unittest.TestCase):  # pylint: disable=too-many-public-methods
    ...
    def test_main_releases_lock_when_run_finishes(
        ...
        mock_resolve_token.return_value = "token-value"
        mock_create_provider.return_value = _FakeProviderWithAuth()
        mock_import_module.return_value = _FakeGitModule()
